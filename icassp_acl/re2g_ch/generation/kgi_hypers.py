...
from transformers import RagTokenizer, RagSequenceForGeneration, RagTokenForGeneration, BertTokenizer
...
class KgiHypers(HypersBase):
    ...
    def get_tokenizer_and_model(self):
        ...
        tokenizer.current_tokenizer = BertTokenizer.from_pretrained('hfl/chinese-bert-wwm-ext')
        tokenizer.generator = BertTokenizer.from_pretrained('/mnt/data/huairang/Doc2dial/rag/pretrained/fnlp/bart-large-chinese')
        tokenizer.question_encoder = BertTokenizer.from_pretrained('hfl/chinese-bert-wwm-ext')
