from transformers import (DPRQuestionEncoder, RagTokenizer, RagTokenForGeneration, BertTokenizer)
import torch
...
tokenizer.generator = BertTokenizer.from_pretrained('fnlp/bart-large-chinese')
