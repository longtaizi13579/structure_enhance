...
from transformers import (DPRContextEncoderTokenizerFast, DPRQuestionEncoderTokenizerFast, BertTokenizer)
import logging
import time
...
qry_tokenizer = BertTokenizer.from_pretrained('hfl/chinese-roberta-wwm-ext')
ctx_tokenizer = BertTokenizer.from_pretrained('hfl/chinese-roberta-wwm-ext')
