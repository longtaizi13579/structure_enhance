...
import numpy as np
import base64
from transformers import RagTokenizer, RagTokenForGeneration, DPRQuestionEncoder, RagConfig, BertTokenizer
import logging
...
class RetrieverDPR(RetrieverBase):
    def __init__(self, hypers: DPRHypers, *, apply_mode=False):
        ...
        tokenizer.current_tokenizer = BertTokenizer.from_pretrained('hfl/chinese-roberta-wwm-ext')
        tokenizer.generator = BertTokenizer.from_pretrained('/mnt/data/huairang/Doc2dial/rag/pretrained/fnlp/bart-large-chinese')
        tokenizer.question_encoder = BertTokenizer.from_pretrained('hfl/chinese-roberta-wwm-ext')
