...
from transformers import RagTokenizer, RagSequenceForGeneration, RagTokenForGeneration, BertTokenizer, BartTokenizer
...
class KgiHypers(HypersBase):
    ...
    def get_tokenizer_and_model(self):
        ...
        if self.qry_encoder_path:
            tokenizer.current_tokenizer = BertTokenizer.from_pretrained(self.qry_encoder_path)
            tokenizer.question_encoder = BertTokenizer.from_pretrained(self.qry_encoder_path)
            print('dbm')
