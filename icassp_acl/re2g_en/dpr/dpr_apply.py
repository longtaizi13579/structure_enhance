from transformers import (DPRQuestionEncoder, RagTokenizer, RagTokenForGeneration, BertTokenizer, BartTokenizer)
import torch
...
tokenizer.generator = BartTokenizer.from_pretrained('facebook/bart-large')
