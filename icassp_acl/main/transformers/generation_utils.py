...
class GenerationMixin:
    ...
    def _expand_inputs_for_generation(
        ...
        if 'doc_scores' in model_kwargs:
            model_kwargs['doc_scores'] = model_kwargs['doc_scores'].index_select(0, expanded_return_idx)
    ...
    def beam_search(
        ...
        while True:
            ...
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs)
            model_inputs['input_ids'] = model_kwargs['encoder_input_ids']
            if 'doc_scores' in model_kwargs:
                model_inputs['doc_scores'] = model_kwargs['doc_scores']
            outputs = self(
                **model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
