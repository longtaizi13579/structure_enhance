...
logging.basicConfig(filename='512_train_graph_without_structure_without_transformation',level=logging.DEBUG)
...
save_base_directory = './512_train_graph_without_structure_without_transformation_file/'
