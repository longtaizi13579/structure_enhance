...
sys.path.append('/root/data/huihuan/acl_code')
os.chdir('/root/data/huihuan/acl_code')
import logging
import random
import transformers
...
class RerankerTrainer:
    ...
    def train(self):
        ...
        for every_epoch in range(self.args.num_train_epochs):
            ...
            agent.save(f'/root/data/huihuan/acl_code/reinforcement_learning_external/{every_epoch}')
